...
from .factories import PseudopatientFactory
...
class TestPseudopatientQuerySet(TestCase):
    def setUp(self):
        self.pseudopatient = PseudopatientFactory()
        self.pseudopatient.ckd = CkdFactory(user=self.pseudopatient)
        self.pseudopatient.gout = GoutFactory(user=self.pseudopatient)
        ...
        self.goutdetail = GoutDetailFactory(medhistory=self.pseudopatient.gout)
