...
class TestFlareFactory(TestCase):
    ...
    def test__test_create_api_data(self):
        factory = CustomFlareFactory()
        data = factory.create_api_data()
        self.assertTrue(data)
        self.assertTrue(isinstance(data, dict))
        self.assertTrue("onset" in data)
        self.assertTrue(isinstance(data["onset"], bool))
        self.assertTrue("redness" in data)
        self.assertTrue(isinstance(data["redness"], bool))
        self.assertTrue("joints" in data)
        self.assertTrue(isinstance(data["joints"], list))
        ...
        self.assertTrue(isinstance(data["crystal_analysis"], bool) or data["crystal_analysis"] is None)
        self.assertTrue("aki" in data)
        self.assertTrue(isinstance(data["aki"], dict) or data["aki"] is None)
        self.assertTrue("dateofbirth" in data)
        self.assertTrue(isinstance(data["dateofbirth"], dict) or data["dateofbirth"] is None)
        self.assertTrue("gender" in data)
        self.assertTrue(isinstance(data["gender"], dict) or data["gender"] is None)
        self.assertTrue("urate" in data)
        self.assertTrue(isinstance(data["urate"], dict) or data["urate"] is None)
        for medhistory in FLARE_MEDHISTORYS:
            self.assertTrue(medhistory.lower() in data)
            self.assertTrue(isinstance(data[medhistory.lower()], dict))
