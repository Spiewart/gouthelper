...
class TestFlaresFlareOneActiveFlarePerPatient(TestCase):
    def setUp(self):
        self.psp = create_psp()
    ...
    def test__constraint_without_patient_does_not_raise_IntegrityError(self):
        Flare.objects.create(
...
class TestFlaresFlareExcludePatientOverlapping(TestCase):
    def setUp(self):
        self.psp = create_psp()
    ...
    def test__constraint_does_not_raise_IntegrityError_with_patient(self):
        Flare.objects.create(
            patient=self.psp,
            joints=[LimitedJointChoices.ANKLEL],
            date_started=date.today() - timedelta(days=10),
    ...
    def test__constraint_does_not_raise_IntegrityError_without_patient(self):
        Flare.objects.create(
            patient=None,
            dateofbirth=DateOfBirthFactory(),
            gender=GenderFactory(),
