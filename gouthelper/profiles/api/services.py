...
class PseudopatientProfileAPIMixin(APIMixin):
    ...
    def check_for_pseudopatientprofile_update_errors(self):
        if not self.pseudopatientprofile:
            self.add_errors(
                api_args=[("pseudopatientprofile", "No PseudopatientProfile to update.")],
            )
...
class PseudopatientProfileAPI(
    ...
    def __init__(
        self,
        pseudopatientprofile: Union["UUID", None] = None,
        provider: Union["UUID", None] = None,
        patient: Union["UUID", None] = None,
    ):
        super().__init__(patient=patient)
        self.pseudopatientprofile = pseudopatientprofile
